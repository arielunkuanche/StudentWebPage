 ...
 * 
 * - Reusable DBMS connection configuration parameter settings - NB! This
 * version is to be used in *** Dynamic Web Projects ***
 * 
...
public class MyConnectionParameters {
	...
	public static String getDatabaseLocation() {
		...
		path += File.separator + projectName + File.separator + databaseFolder + File.separator;
